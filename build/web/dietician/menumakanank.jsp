				...
				<div class="container">
					...
					<div class="main-navigation pull-right">
						...
						<ul class="menu">
							...
							<li class="menu-item current-menu-item"><a href="menumakanank.jsp">Menu Diet</a></li>
			...
			<main class="main-content">
				...
				<div class="content">
					<div class="container">
                                            ...
                                            <h3><center>Menu makanan ini diperuntukkan seseorang yang ingin melakukan Diet Menguruskan Berat Badan</center></h3>
                                            <p><center>Hai Kamu, yang mengikuti Program Diet untuk menguruskan berat badan, harus mengikuti jadwal makan sesuai menu makanan yang telah kami berikan, semangat ya untuk dietnya</center></h3>
						...
						<div class="row">
                                                   ...
                                                   <jsp:include page="menupagi.jsp" flush="true">  <jsp:param name="link" value="<%=link%>"/> </jsp:include> 
						</div>
                                                <div class="row">
                                                    <div><center><h1>Kategori Menu Makan Siang</h1></center></div>
                                                   <% String link1=request.getParameter("link"); %> 
                                                   <jsp:include page="menusiang.jsp" flush="true">  <jsp:param name="link1" value="<%=link%>"/> </jsp:include> 
						</div>
                                                <div class="row">
                                                    <div><center><h1>Kategori Menu Makan Malam</h1></center></div>
                                                   <% String link2=request.getParameter("link"); %> 
                                                   <jsp:include page="menumalam.jsp" flush="true">  <jsp:param name="link2" value="<%=link%>"/> </jsp:include> 
						</div>
						<hr>
					</div>
				</div>
